...
if __name__ == "__main__":
    ...
    fig.tight_layout()
    fig.savefig("/home/claude/taller_caos/figuras/bifurcacion_completo.png", dpi=150)
    ...
    fig2.tight_layout()
    fig2.savefig("/home/claude/taller_caos/figuras/bifurcacion_zoom.png", dpi=150)
    ...
    ax3.legend()
    fig3.tight_layout()
    fig3.savefig("/home/claude/taller_caos/figuras/bifurcacion_ventana_periodica.png", dpi=150)
